...
import * as sty from "./PlasmicIconLink.module.css"; // plasmic-import: BTNrH-X8sJtFz/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(defaultcss.all, sty.svg__vcW29)}
              role={"img"}
            />
          ),
